    ...
    def assign_home(self, images: dict):
        ...
        body = [
            {"type": "hero", "value": {
                ...
                "add_to_bag": False,
                "primary_cta": link("Discover the kit", "#kit"),
                "secondary_cta": {},
            ...
            {"type": "features", "value": {
                ...
                "items": [
                    {"icon": "leather", "title": "The kit", "description": "A design beyond the ordinary.", "link": "#kit"},
                    {"icon": "mirror", "title": "Light", "description": "Built-in LED mirror.", "link": "#light"},
                    {"icon": "drawers", "title": "Every layer", "description": "Three curated layers.", "link": "#layers"},
                    {"icon": "travel", "title": "Compact", "description": "Three centimetres thick.", "link": "#compact"},
                    {"icon": "sparkle", "title": "Your ritual", "description": "Make it yours.", "link": "#shop"},
                ],
            }},
            {"type": "image_text", "value": {
                "anchor_id": "kit", "chapter": "01",
                "eyebrow": "The kit",
                "heading": "A design\n_beyond the ordinary._",
                "body": "<p>Premium materials. Thoughtful details. Timeless elegance.</p>",
                "image": img("material"),
                "image_position": "right",
                "cta": link("Explore the details", f"/products/{product.slug}", "text"),
            }},
            ...
            {"type": "drawer_showcase", "value": {
                ...
                "intro": "Everything you need, exactly where you want it. Lips, complexion and eyes, organised in a slim, travel-ready case.",
                "source": "product", "product": product.pk, "layers": [],
            }},
            {"type": "product_details", "value": {
                "anchor_id": "compact", "chapter": "04",
                "eyebrow": "Compact form",
                "heading": "Small size.\n_Big beauty._",
                "intro": "A complete beauty system in a case just three centimetres thick.",
